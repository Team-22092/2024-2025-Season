...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =  -2225.498616397954; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1779.908470597565; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 31.02939994528207; // x position of the perpendicular encoder (in tick units)
    }
