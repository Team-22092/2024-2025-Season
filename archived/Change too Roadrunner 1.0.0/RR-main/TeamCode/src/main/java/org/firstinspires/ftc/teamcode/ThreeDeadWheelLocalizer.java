...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2194.386397907189; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1720.97463263862; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 334.1548249859567; // x position of the perpendicular encoder (in tick units)
    }
